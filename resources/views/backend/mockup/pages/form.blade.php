...
@if (url()->current() == route('backend.{{ model }}.create'))
	<div class="form-group row">
		...
		<div class="col-md-6">
			<div class="card card-warning border border-warning">
				<div class="card-header">
					<h3 class="card-title text-white">If you need to reset the password for this {{ model }}.</h3>
				</div>
				<div class="card-body">
					<div class="form-group row">
		...
		<div class="input-group">
			...
			@if (${{ model }}->has_avatar)
				<div class="input-group-append">
					<img src="{{ ${{ model }}->avatar_thumb }}" alt="Avatar Image" height="38">
				</div>
			@endif
		</div>
...
<div class="form-group row">
	...
	<div class="col-sm-10">
	      <input type="text" readonly class="form-control-plaintext" value="{{ ${{ model }}->created_at->diffForHumans() }} ({{ ${{ model }}->display_created_at_full_thai }})">
	</div>
</div>
@endisset